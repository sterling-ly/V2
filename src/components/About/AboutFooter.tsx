  ...
  return (
    <>
      ...
      <SocialLinks>
        ...
        >
          <SocialLink href="https://twitter.com/sterling_fi" target="_blank" rel="noopener noreferrer">
            <TwitterIcon size={32} />
          </SocialLink>
        </TraceEvent>
        <SocialLink href="https://github.com/sterl-o" target="_blank" rel="noopener noreferrer">
          <GithubIcon size={32} />
        </SocialLink>
      </SocialLinks>
